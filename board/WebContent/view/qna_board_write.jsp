...
<section class="content">
	<div class="box box-primary">
		...
		<form action="../insert.do" method="post" role="form">
			<div class="box-body">
				<div class="form-group row">
					<label for="name" class="col-sm-2 col-form-label">작성자</label>
					<div class="col-sm-10">
					<input type="text" name="name" size="10" class="form-control" maxlength='10' required="required">
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
					<textarea name='content' cols='60' class="form-control" rows='15' required></textarea>
					</div>
				</div>
				<div class="form-group row">
